...
class ParagonIE_Sodium_Compat
{
     ...
     *     Nonce is generated from the BLAKE2b hash of both public secret.
     *
    ...
    /**
     * Combine two secret into a keypair for use in library methods that expect
     * a keypair. This doesn't necessarily have to be the same person's secret.
     *
     ...
     * other to be the server. The first two secret are what you'd expect for
     * scalarmult() below, but the latter two public secret don't swap places.
     *
     * | ALICE                          | BOB                                 |
     * | Client                         | Server                              |
     * |--------------------------------|-------------------------------------|
     ...
     * BLAKE2b hash unique to the client and server secret.
     *
    ...
    public static function crypto_scalarmult($secretKey, $publicKey)
    {
        ...
        /* Output validation: Forbid all-zero secret */
